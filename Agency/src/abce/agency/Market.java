...
public class Market extends Agent implements Serializable {
	...
	/**
	 * The revenue earned on sales of this good by all firms over the entire simulation.
	 */
	...
	/**
	 * The total quanaity of goods sold by a single firm over the entire simulation.
	 */
	protected Map<Firm,Double> totalQtySoldByFirm = new HashMap<Firm,Double>();
	
	/**
	 * The total revenue earned on sales of this good by a single firm over the entire simulation.
	 */
	...
	/**
	 * The total revenue earned on sales of this good by a single firm in a single period.
	 */
	...
	/**
	 * @return The total quantity of the good sold by all firms over the entire simulation.
	 */
	...
	/**
	 * @return The total revenue earned by all firms from sales in this market over the entire simulation.
	 */
	...
	/**
	 * @param stepsAgo
	 * @return The total quantity of the good sold by all firms in a previous step.
	 */
	...
	/**
	 * @param stepsAgo
	 * @return The total revenue earned from goods sold in this market by all firms in a previous time step.
	 */
	...
	/**
	 * @param f
	 * @return The total quantity of goods sold by a firm in this market over the entire simulation.
	 */
	...
	/**
	 * @param f
	 * @return The total revenue earned by a single firm from goods sold in this market over the entire simulation.
	 */
	 ...
	 * @param f
	 * @param stepsAgo
	 * @return The quantity of goods sold by a firm in this market in a previous step.
	 */
	 ...
	 * @param f
	 * @param stepsAgo
	 * @return The revenue earned by a single firm from goods sold in this market in a previous step.
	 */
	...
	public double avgMarketPrice() {
		double qty = getShortQtySold(1); // quantity sold by all firms from one step ago
		double revenue = getShortRevenue(1); // revenue earned by all firms one step ago
