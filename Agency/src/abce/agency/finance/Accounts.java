...
public class Accounts extends Agent implements Serializable, Steppable {
	...
	private Map<Object, Double> assetAcquisitionCosts = new HashMap<Object,Double>();
	private Map<Object, Double> assetValues = new HashMap<Object,Double>();
	private double assetsValue;  // cached sum of above
	
	/*
	 * Short-term tracking accounts
	 */
	private double[] shortInvestment = new double[trackingPeriods];
	private double[] shortInterestPayments = new double[trackingPeriods];
	private double[] shortOperationsCost = new double[trackingPeriods];
	private double[] shortRevenue = new double[trackingPeriods];
	private Map<Asset,double[]> shortAssetRevenues = new HashMap<Asset,double[]>();
	private Map<Good,double[]> shortGoodsRevenue = new HashMap<Good,double[]>();
	private Map<Good,double[]> shortProductionCosts = new HashMap<Good,double[]>();
	...
	private double totalOperationsCost = 0;
	private double totalRevenue = 0;
	private Map<Asset,Double> totalAssetRevenue = new HashMap<Asset,Double>();
	private Map<Good,Double> totalGoodsRevenue = new HashMap<Good,Double>();
	private Map<Good,Double> totalProductionCosts = new HashMap<Good,Double>();
	...
	/**
	 * @param capital  The capital asset/good being capitalized.  (required)
	 * @param price  The aquisition cost of the capital
	...
	/**
	 * @param capitalAsset The capital asset with which this revenue is associated
	...
	/**
	 * Spend the specified cost to produce the specified quantity of the specified goods.
	...
	/**
	 * Checks to see if the firm has enough resources to support the proposed production
	 * at the proposed cost.  
	 * 
	 * @param productionAction the proposed production
	 * @param cost the cost thereof
	 * @return true if the firm is financially <i>capable</i> of financing the production,
	 * 				false otherwise.
	 */
